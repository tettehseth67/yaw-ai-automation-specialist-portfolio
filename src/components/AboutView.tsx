        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-center">
            <div className="relative w-full max-w-[360px] aspect-[4/5] rounded-3xl overflow-hidden border border-gray-200/85 dark:border-zinc-800 p-2.5 bg-white dark:bg-zinc-900 shadow-2xl">
              ...
              <img 
                src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=600&h=750&q=80" 
                alt="AI Automation and Systems Integration" 
                className="h-full w-full object-cover rounded-2xl filter contrast-[1.05] brightness-[0.95]"
                referrerPolicy="no-referrer"
              />
              {/* Overlay Tag */}
              <div className="absolute bottom-6 left-6 right-6 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md rounded-2xl p-4 border border-gray-100 dark:border-zinc-800 shadow-lg">
                <p className="text-xs font-black text-gray-900 dark:text-white leading-none">Yaw</p>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-sm sm:text-base text-gray-800 dark:text-gray-100 leading-relaxed font-bold">
              I'm an AI Automation Specialist and Front-End Web Developer passionate about helping businesses work smarter and grow faster through intelligent automation and modern web solutions.
            </p>

            {/* In-depth background narrative */}
            <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 space-y-3.5 leading-relaxed font-medium">
              <p>
              ...
              <p>
                Using technologies such as Make, Zapier, Python, OpenAI, LangChain, and other modern automation platforms, I design solutions that eliminate bottlenecks, improve operational efficiency, and create seamless digital experiences.
              </p>
            </div>

            {/* Distinct custom bullet items matching the layout photo */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 pb-2">
              <div className="flex items-center space-x-3.5 p-3 rounded-2xl bg-gray-50/50 dark:bg-zinc-900/30 border border-gray-100 dark:border-zinc-850 shadow-sm">
                ...
                <div>
                  <h4 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-wider">AI Automation</h4>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3.5 p-3 rounded-2xl bg-gray-50/50 dark:bg-zinc-900/30 border border-gray-100 dark:border-zinc-850 shadow-sm">
                ...
                <div>
                  <h4 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-wider">Web Development</h4>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3.5 p-3 rounded-2xl bg-gray-50/50 dark:bg-zinc-900/30 border border-gray-100 dark:border-zinc-850 shadow-sm">
                ...
                <div>
                  <h4 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-wider">Business Growth</h4>
                </div>
              </div>
            </div>

            {/* Custom Slogan Tagline with thick left accent bar */}
